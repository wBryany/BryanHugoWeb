...
function callback (bridge) {
  ...
  JSBridge.NativeCallH5 = function (callBack) {
...
function runActionQueue () {
  ...
  for (var idx in nativeActionQueue) {
    JSBridge.NativeCallH5(nativeActionQueue[idx])
  }
}
